  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm text-muted-foreground">
        You will get a full in-app tour covering writing modes, editor, Story Wiki, settings, review, and dashboard return.
      </p>
      <ul className="space-y-2 text-sm text-muted-foreground">
        <li>- Explore mode switcher (sandbox, canvas, write, review)</li>
        <li>- Write in the editor and link Story Wiki references</li>
        <li>- Add a character in Story Wiki</li>
